...
const ErrorPage = () => {
    return (
        <div className="bg-gray-100 h-[91.2vh] flex justify-center items-center">
            <div className="text-center ml-4 flex flex-col items-center justify-center ">
                <svg
                    className="emoji-404"
                ...
                >
                    ...
                    <path
                        ...
                        fill="#FFEFB5"
                    />
                    <circle cx="113" cy="113" r="109" stroke="#6E6E96" strokeWidth="8" fill="none" />
                </svg>
